...
UPDATE CAR_DM_STG.AG_PROD_PLAN_BUS_PTY_FACT mart
   SET  LAST_CHG_DT = CURRENT_TIMESTAMP,
        DATA_STAT_CD = 'A',
        AG_PROD_PLAN_SRGT_ID = vault.AG_PROD_PLAN_SRGT_ID,      
        AG_PROD_PLAN_DURB_ID = vault.AG_PROD_PLAN_DURB_ID,      
        PGM_YR = vault.PGM_YR,
        ...
        CUST_SRGT_ID = vault.CUST_SRGT_ID,
        CUST_DURB_ID = vault.CUST_DURB_ID,
        PRDR_INVL_SRGT_ID = vault.PRDR_INVL_SRGT_ID,
        PRDR_INVL_DURB_ID = vault.PRDR_INVL_DURB_ID,
        AG_PROD_PLAN_BUS_PTY_CRE_DT = vault.AG_PROD_PLAN_BUS_PTY_CRE_DT,
        AG_PROD_PLAN_PTY_LAST_CHG_DT = vault.AG_PROD_PLAN_PTY_LAST_CHG_DT,
        AG_PROD_PLAN_PTY_LAST_CHG_USER = vault.AG_PROD_PLAN_PTY_LAST_CHG_USER,
        LAND_UNIT_RMA_NBR = vault.LAND_UNIT_RMA_NBR,
        CROP_SHR_PCT = vault.CROP_SHR_PCT,
        SRC_DATA_STAT_CD = vault.SRC_DATA_STAT_CD,
        CONT_PLAN_CERT_ELCT_DT = vault.CONT_PLAN_CERT_ELCT_DT,
        HEMP_LIC_NBR = vault.HEMP_LIC_NBR,
        FLD_YR_SRGT_ID = vault.FLD_YR_SRGT_ID,
        FLD_DURB_ID = vault.FLD_DURB_ID,
        BUS_PTY_SRC_DATA_STAT_CD = vault.BUS_PTY_SRC_DATA_STAT_CD
   FROM vault
