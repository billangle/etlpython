...
UPDATE CAR_DM_STG.AG_PROD_PLAN_FACT mart
   SET  LAST_CHG_DT = CURRENT_TIMESTAMP,
        DATA_STAT_CD = 'A',
        CROP_ACRG_RPT_SRGT_ID = vault.CROP_ACRG_RPT_SRGT_ID,
        CROP_ACRG_RPT_DURB_ID = vault.CROP_ACRG_RPT_DURB_ID,
        PGM_YR = vault.PGM_YR,
        ADM_FSA_ST_CNTY_SRGT_ID = vault.ADM_FSA_ST_CNTY_SRGT_ID,
        ADM_FSA_ST_CNTY_DURB_ID = vault.ADM_FSA_ST_CNTY_DURB_ID,
        FARM_SRGT_ID = vault.FARM_SRGT_ID,
        FARM_DURB_ID = vault.FARM_DURB_ID,
        OPER_CUST_DURB_ID = vault.OPER_CUST_DURB_ID,
        OPER_CUST_SRGT_ID = vault.OPER_CUST_SRGT_ID,
        TR_SRGT_ID = vault.TR_SRGT_ID,
        TR_DURB_ID = vault.TR_DURB_ID,
        LOC_FSA_ST_CNTY_DURB_ID = vault.LOC_FSA_ST_CNTY_DURB_ID,
        LOC_FSA_ST_CNTY_SRGT_ID = vault.LOC_FSA_ST_CNTY_SRGT_ID,
        FSA_CROP_SRGT_ID = vault.FSA_CROP_SRGT_ID,
        FSA_CROP_DURB_ID = vault.FSA_CROP_DURB_ID,
        INTN_USE_DURB_ID = vault.INTN_USE_DURB_ID,
        INTN_USE_SRGT_ID = vault.INTN_USE_SRGT_ID,
        PLNT_MULT_CROP_STAT_SRGT_ID = vault.PLNT_MULT_CROP_STAT_SRGT_ID,
        PLNT_MULT_CROP_STAT_DURB_ID = vault.PLNT_MULT_CROP_STAT_DURB_ID,
        PLNT_SCND_STAT_SRGT_ID = vault.PLNT_SCND_STAT_SRGT_ID,
        PLNT_SCND_STAT_DURB_ID = vault.PLNT_SCND_STAT_DURB_ID,
        PLNT_PRIM_STAT_SRGT_ID = vault.PLNT_PRIM_STAT_SRGT_ID,
        PLNT_PRIM_STAT_DURB_ID = vault.PLNT_PRIM_STAT_DURB_ID,
        LAND_USE_SRGT_ID = vault.LAND_USE_SRGT_ID,
        LAND_USE_DURB_ID = vault.LAND_USE_DURB_ID,
        CROP_PLNT_DT_ID = vault.CROP_PLNT_DT_ID,
        CERT_DT_ID = vault.CERT_DT_ID,
        ORGN_PLNT_DT_ID = vault.ORGN_PLNT_DT_ID,
        CONG_DIST_DURB_ID = vault.CONG_DIST_DURB_ID,
        CONG_DIST_SRGT_ID = vault.CONG_DIST_SRGT_ID,
        PLNT_PRD_SRGT_ID = vault.PLNT_PRD_SRGT_ID,
        PLNT_PRD_DURB_ID = vault.PLNT_PRD_DURB_ID,
        IRR_PRAC_SRGT_ID = vault.IRR_PRAC_SRGT_ID,
        IRR_PRAC_DURB_ID = vault.IRR_PRAC_DURB_ID,
        ACRG_OFCL_MEAS_SRGT_ID = vault.ACRG_OFCL_MEAS_SRGT_ID,
        CROP_RPT_UNIT_SRGT_ID = vault.CROP_RPT_UNIT_SRGT_ID,
        CROP_RPT_UNIT_DURB_ID = vault.CROP_RPT_UNIT_DURB_ID,
        PLNT_PTRN_TYPE_SRGT_ID = vault.PLNT_PTRN_TYPE_SRGT_ID,
        PLNT_PTRN_TYPE_DURB_ID = vault.PLNT_PTRN_TYPE_DURB_ID,
        CNCUR_PLNT_SRGT_ID = vault.CNCUR_PLNT_SRGT_ID,
        CNCUR_PLNT_DURB_ID = vault.CNCUR_PLNT_DURB_ID,
        OGNC_PRAC_TYPE_SRGT_ID = vault.OGNC_PRAC_TYPE_SRGT_ID,
        OGNC_PRAC_TYPE_DURB_ID = vault.OGNC_PRAC_TYPE_DURB_ID,
        CROP_PRAC_SRGT_ID = vault.CROP_PRAC_SRGT_ID,
        CROP_PRAC_DURB_ID = vault.CROP_PRAC_DURB_ID,
        RPT_ACRG_MOD_RSN_SRGT_ID = vault.RPT_ACRG_MOD_RSN_SRGT_ID,
        RPT_ACRG_MOD_RSN_DURB_ID = vault.RPT_ACRG_MOD_RSN_DURB_ID,
        ACRG_CALC_PRJ_SRGT_ID = vault.ACRG_CALC_PRJ_SRGT_ID,
        ACRG_CALC_PRJ_DURB_ID = vault.ACRG_CALC_PRJ_DURB_ID,
        PLNT_DT_MOD_RSN_SRGT_ID = vault.PLNT_DT_MOD_RSN_SRGT_ID,
        PLNT_DT_MOD_RSN_DURB_ID = vault.PLNT_DT_MOD_RSN_DURB_ID,
        CROP_INTN_USE_DURB_ID = vault.CROP_INTN_USE_DURB_ID,
        CROP_INTN_USE_SRGT_ID = vault.CROP_INTN_USE_SRGT_ID,
        ACRG_OFCL_MEAS_DURB_ID = vault.ACRG_OFCL_MEAS_DURB_ID,
        AG_PROD_PLAN_CRE_DT = vault.AG_PROD_PLAN_CRE_DT,
        AG_PROD_PLAN_LAST_CHG_DT = vault.AG_PROD_PLAN_LAST_CHG_DT,
        AG_PROD_PLAN_LAST_CHG_USER_NM = vault.AG_PROD_PLAN_LAST_CHG_USER_NM,
        FLD_NBR = vault.FLD_NBR,
        SFLD_NBR = vault.SFLD_NBR,
        DATA_IACTV_DT = vault.DATA_IACTV_DT,
        FLD_ID = vault.FLD_ID,
        NAP_UNIT_NBR = vault.NAP_UNIT_NBR,
        NAP_UNIT_OVRRD_IND = vault.NAP_UNIT_OVRRD_IND,
        GSPTL_AG_PROD_PLAN_ID = vault.GSPTL_AG_PROD_PLAN_ID,
        CPLD_IND = vault.CPLD_IND,
        SKIP_ROW_WDTH = vault.SKIP_ROW_WDTH,
        CROP_ROW_WDTH = vault.CROP_ROW_WDTH,
        CROP_ROW_CT = vault.CROP_ROW_CT,
        SKIP_ROW_CT = vault.SKIP_ROW_CT,
        TREE_SEP_LGTH = vault.TREE_SEP_LGTH,
        TREE_AGE = vault.TREE_AGE,
        TREE_UNIT_CT = vault.TREE_UNIT_CT,
        DTER_ACRG_IND = vault.DTER_ACRG_IND,
        CROP_FLD_DTER_QTY = vault.CROP_FLD_DTER_QTY,
        CROP_FLD_RPT_QTY = vault.CROP_FLD_RPT_QTY,
        PRNL_CROP_EXPR_YR = vault.PRNL_CROP_EXPR_YR,
        CROP_PLNT_PCT = vault.CROP_PLNT_PCT,
        COC_DAPRV_ACRG_IND = vault.COC_DAPRV_ACRG_IND,
        NTV_PSTR_CVSN_IND = vault.NTV_PSTR_CVSN_IND,
        CORE_PROD_CD = vault.CORE_PROD_CD,
        CORE_PROD_TYPE_CD = vault.CORE_PROD_TYPE_CD,
        PROD_INTN_USE_CD = vault.PROD_INTN_USE_CD,
        ORGN_RPT_ACRG = vault.ORGN_RPT_ACRG,
        RPT_ACRG_MOD_IND = vault.RPT_ACRG_MOD_IND,
        RPT_ACRG_MOD_OT_RSN_TXT = vault.RPT_ACRG_MOD_OT_RSN_TXT,
        PLNT_DT_MOD_IND = vault.PLNT_DT_MOD_IND,
        PLNT_DT_MOD_OT_RSN_TXT = vault.PLNT_DT_MOD_OT_RSN_TXT,
        CLU_PRDR_RVW_RQST_IND = vault.CLU_PRDR_RVW_RQST_IND,
        SRC_AG_PROD_PLAN_ID = vault.SRC_AG_PROD_PLAN_ID,
        SRC_DATA_STAT_CD = vault.SRC_DATA_STAT_CD,
        ANML_UNIT_PUB_LAND_USE_PCT = vault.ANML_UNIT_PUB_LAND_USE_PCT,
        ANML_UNIT_GRZ_BEG_DT = vault.ANML_UNIT_GRZ_BEG_DT,
        ANML_UNIT_GRZ_END_DT = vault.ANML_UNIT_GRZ_END_DT,
        MULT_CROP_INTN_USE_SRGT_ID = vault.MULT_CROP_INTN_USE_SRGT_ID,
        MULT_CROP_INTN_USE_STAT_DURB_I = vault.MULT_CROP_INTN_USE_STAT_DURB_I,
        ACTL_LAND_USE_SRGT_ID = vault.ACTL_LAND_USE_SRGT_ID,
        ACTL_LAND_USE_DURB_ID = vault.ACTL_LAND_USE_DURB_ID,
        CONT_PLAN_CERT_ELCT_IND = vault.CONT_PLAN_CERT_ELCT_IND,
        FLD_YR_SRGT_ID = vault.FLD_YR_SRGT_ID,
        FLD_DURB_ID = vault.FLD_DURB_ID,
        CROP_LATE_FILE_IND = vault.CROP_LATE_FILE_IND,
        NTV_SOD_CVSN_DT = vault.NTV_SOD_CVSN_DT
   FROM vault
