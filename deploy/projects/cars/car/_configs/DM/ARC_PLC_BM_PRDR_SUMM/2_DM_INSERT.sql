INSERT INTO CAR_DM_STG.ARC_PLC_BM_PRDR_SUMM
(
CORE_CUST_ID
...
SELECT DISTINCT 
cd.CORE_CUST_ID
, COALESCE(appd.CROP_FLD_RPT_QTY * (appbpf.CROP_SHR_PCT/100),0) as CROP_FLD_RPT_SHR_QTY
, COALESCE(appd.CROP_FLD_DTER_QTY * (appbpf.CROP_SHR_PCT/100),0) as CROP_FLD_DTER_SHR_QTY
