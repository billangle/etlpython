  ...
  (SELECT stg.*
   FROM
     (SELECT DISTINCT MD5 (COALESCE (AG_PROD_PLAN.AG_PROD_PLAN_ID::varchar(32), '-1')) AS AG_PROD_PLAN_H_ID,
                      ...
                      AG_PROD_PLAN.IRR_PRAC_CD,
                      AG_PROD_PLAN.FLD_NBR,
                      AG_PROD_PLAN.SFLD_NBR,
                      AG_PROD_PLAN.ANML_UNIT_PUB_LAND_USE_PCT,
                      AG_PROD_PLAN.ANML_UNIT_GRZ_BEG_DT,
                      AG_PROD_PLAN.ANML_UNIT_GRZ_END_DT,
                      AG_PROD_PLAN.SKIP_ROW_PTRN_CD,
                      AG_PROD_PLAN.MULT_CROP_INTN_USE_STAT_CD,
      ...
      ORDER BY AG_PROD_PLAN.CDC_DT) stg
   LEFT JOIN edv.AG_PROD_PLAN_HS dv ON (stg.HASH_DIF = dv.HASH_DIF
