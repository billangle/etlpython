INSERT INTO CAR_DM_STG.ARC_PLC_SHR_QTY_DBL_CRP_SUMM 
(PGM_YR,
ST_FSA_CD,
CNTY_FSA_CD,
farm_nbr,
...
SELECT appd.PGM_YR,
             ...
             appd.farm_nbr,
             cd.CORE_CUST_ID,
             COALESCE (appd.CROP_FLD_RPT_QTY * (appbpf.CROP_SHR_PCT / 100), 0)
                 AS CROP_FLD_RPT_QTY,
             COALESCE (appd.CROP_FLD_DTER_QTY * (appbpf.CROP_SHR_PCT / 100), 0)
                 AS CROP_FLD_DTER_QTY,
             appd.CPLD_IND,
             appd.FSA_CROP_CD
