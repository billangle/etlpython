...
LAMBDA_NAME="${LAMBDA_NAME:-FSA-steam-dev-DownloadZip}"
REGION="${AWS_REGION:-${AWS_DEFAULT_REGION:-us-east-1}}"

SOURCE_BUCKET="${SOURCE_BUCKET:-punkdev-fpacfsa-landing-zone}"
SOURCE_FOLDER="${SOURCE_FOLDER:-carspython}"                 # empty = bucket root
DEST_BUCKET="${DEST_BUCKET:-dev-cars-artifacts}"
