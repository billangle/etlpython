...
ewt40ofrsc.dafp_approved_date dafp_aprv_dt,
...
'CNSV_EWT40OFRSC' as data_src_nm,
...
where ewt40ofrsc.op <> 'D'
  and ewt40ofrsc.dart_filedate between TO_DATE('{ETL_START_DATE}') and TO_DATE('{ETL_END_DATE}')
