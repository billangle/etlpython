...
def handler(event, context):
    ...
    if crawler_status:
            ...
            if job_stat_nm == 'In Progress' and last_cplt_data_load_tgt_nm == 'FSA-CERT-CNSV' and crawler_status == 'SUCCEEDED':
            ...
            data_ppln_job_update_on_complete_sql = f"""
                ...
                set job_end_dt = %s,
                    ...
                    job_stat_nm = %s,err_msg_txt = %s, data_stat_cd = %s
