...
AS ( 
    ...
    FROM EDV.LOC_AREA_MRT_SRC_RS LOC_AREA_MRT_SRC_RS
        ,EDV.FARM_TR_L FARM_TR_L
        ,EDV.CLU_YR_LS CLU_YR_LS
        ,EDV.TR_H TR_H
    WHERE (
            CAST(LOC_AREA_MRT_SRC_RS.DATA_EFF_STRT_DT AS DATE) = TO_TIMESTAMP('{V_CDC_DT}', 'YYYY-MM-DD')
            OR CAST(LOC_AREA_MRT_SRC_RS.DATA_EFF_END_DT AS DATE) = TO_TIMESTAMP('{V_CDC_DT}', 'YYYY-MM-DD')
            )
    ...
    SELECT DISTINCT CLU_YR_LS.FARM_TR_L_ID INCR_DR_ID
        ,CLU_YR_ID
        ,PGM_YR
    FROM EDV.CNSV_PRAC_RS CNSV_PRAC_RS
        ,EDV.CLU_YR_LS CLU_YR_LS
    WHERE (
            CAST(CNSV_PRAC_RS.DATA_EFF_STRT_DT AS DATE) = TO_TIMESTAMP('{V_CDC_DT}', 'YYYY-MM-DD')
            OR CAST(CNSV_PRAC_RS.DATA_EFF_END_DT AS DATE) = TO_TIMESTAMP('{V_CDC_DT}', 'YYYY-MM-DD')
            )
    ...
    SELECT DISTINCT CLU_YR_LS.FARM_TR_L_ID INCR_DR_ID
        ,CLU_YR_ID
        ,PGM_YR
    FROM EDV.FLD_HEL_STAT_RS FLD_HEL_STAT_RS
        ,EDV.CLU_YR_LS CLU_YR_LS
    WHERE (
            CAST(FLD_HEL_STAT_RS.DATA_EFF_STRT_DT AS DATE) = TO_TIMESTAMP('{V_CDC_DT}', 'YYYY-MM-DD')
            OR CAST(FLD_HEL_STAT_RS.DATA_EFF_END_DT AS DATE) = TO_TIMESTAMP('{V_CDC_DT}', 'YYYY-MM-DD')
            )
    ...
    SELECT DISTINCT CLU_YR_LS.FARM_TR_L_ID INCR_DR_ID
        ,CLU_YR_ID
        ,PGM_YR
    FROM EDV.LAND_CLS_RS LAND_CLS_RS
        ,EDV.CLU_YR_LS CLU_YR_LS
    WHERE (
            CAST(LAND_CLS_RS.DATA_EFF_STRT_DT AS DATE) = TO_TIMESTAMP('{V_CDC_DT}', 'YYYY-MM-DD')
            OR CAST(LAND_CLS_RS.DATA_EFF_END_DT AS DATE) = TO_TIMESTAMP('{V_CDC_DT}', 'YYYY-MM-DD')
            )
            ...
            FROM (
                ...
                ( SELECT * FROM EDV.CLU_YR_LS 
                  WHERE PGM_YR IS NOT NULL AND FLD_NBR IS NOT NULL  AND    DATA_STAT_CD <> 'D'
                    AND CAST(COALESCE(DATA_EFF_STRT_DT, TO_TIMESTAMP('1111-12-31', 'YYYY-MM-DD')) AS DATE) <= TO_TIMESTAMP('{V_CDC_DT}', 'YYYY-MM-DD')
                ) DV_DR
                ...
                WHERE   FR_DIM.FARM_DURB_ID IS NOT NULL
                    AND TR_DIM.TR_DURB_ID IS NOT NULL
                    AND CAST(COALESCE(DV_DR.DATA_EFF_STRT_DT, TO_TIMESTAMP('1111-12-31', 'YYYY-MM-DD')) AS DATE) <= TO_TIMESTAMP('{V_CDC_DT}', 'YYYY-MM-DD')
                    AND CAST(COALESCE(LAMS.DATA_EFF_STRT_DT, TO_TIMESTAMP('1111-12-31', 'YYYY-MM-DD')) AS DATE) <= TO_TIMESTAMP('{V_CDC_DT}', 'YYYY-MM-DD')
                    AND CAST(COALESCE(THS.DATA_EFF_STRT_DT, TO_TIMESTAMP('1111-12-31', 'YYYY-MM-DD')) AS DATE) <= TO_TIMESTAMP('{V_CDC_DT}', 'YYYY-MM-DD')
                    AND CAST(COALESCE(LAMSR.DATA_EFF_STRT_DT, TO_TIMESTAMP('1111-12-31', 'YYYY-MM-DD')) AS DATE) <= TO_TIMESTAMP('{V_CDC_DT}', 'YYYY-MM-DD')
                    AND CAST(COALESCE(CPRS.DATA_EFF_STRT_DT, TO_TIMESTAMP('1111-12-31', 'YYYY-MM-DD')) AS DATE) <= TO_TIMESTAMP('{V_CDC_DT}', 'YYYY-MM-DD')
                    AND CAST(COALESCE(FHSRS.DATA_EFF_STRT_DT, TO_TIMESTAMP('1111-12-31', 'YYYY-MM-DD')) AS DATE) <= TO_TIMESTAMP('{V_CDC_DT}', 'YYYY-MM-DD')
                    AND CAST(COALESCE(LCRS.DATA_EFF_STRT_DT, TO_TIMESTAMP('1111-12-31', 'YYYY-MM-DD')) AS DATE) <= TO_TIMESTAMP('{V_CDC_DT}', 'YYYY-MM-DD')
                    AND CAST(COALESCE(LAMSRS.DATA_EFF_STRT_DT, TO_TIMESTAMP('1111-12-31', 'YYYY-MM-DD')) AS DATE) <= TO_TIMESTAMP('{V_CDC_DT}', 'YYYY-MM-DD')
                ) sub_1
            WHERE SRC_RANK = 1
            ) sub
        ) DM_1
