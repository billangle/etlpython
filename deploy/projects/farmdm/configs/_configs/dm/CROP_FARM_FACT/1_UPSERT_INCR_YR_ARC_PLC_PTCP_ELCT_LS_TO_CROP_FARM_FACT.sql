SELECT /*+ parallel(12) */  DM.FARM_SRGT_ID
    ,DM.FARM_DURB_ID
    ...
    ,DM.DATA_EFF_STRT_DT
FROM (
    SELECT /*+ ordered */ DM_1.FARM_SRGT_ID
        ,DM_1.FARM_DURB_ID
    ...
    FROM (
        ...
        FROM (
                ...
                ON (COALESCE(LAMS.LOC_AREA_CAT_NM, '[NULL IN SOURCE]') = LAH.LOC_AREA_CAT_NM
                    ...
                    AND LAMS.LOC_AREA_MRT_CD_SRC_ACRO = 'FSA')                   
                LEFT JOIN CMN_DIM_DM.FSA_ST_CNTY_DIM FS_DIM 
                ...
                LEFT JOIN FARM_DM.ARC_PLC_ELG_DTER_DIM APED_DIM 
    ...
    WHERE TRUNC(COALESCE(DV_DR_DATA_EFF_STRT_DT, TO_TIMESTAMP('1111-12-31', 'YYYY-MM-DD'))) <= TO_TIMESTAMP('2025-12-01', 'YYYY-MM-DD')
          AND TRUNC(COALESCE(LAMS_DATA_EFF_STRT_DT, TO_TIMESTAMP('1111-12-31', 'YYYY-MM-DD'))) <= TO_TIMESTAMP('2025-12-01', 'YYYY-MM-DD')
          AND TRUNC(COALESCE(APERS_DATA_EFF_STRT_DT, TO_TIMESTAMP('1111-12-31', 'YYYY-MM-DD'))) <= TO_TIMESTAMP('2025-12-01', 'YYYY-MM-DD')
          /*** 6-24-2019 ***/
          AND TRUNC(COALESCE(APEDRS_DATA_EFF_STRT_DT, TO_TIMESTAMP('1111-12-31', 'YYYY-MM-DD'))) <= TO_TIMESTAMP('2025-12-01', 'YYYY-MM-DD')
          /*** 7-22-2019 ***/
          AND TRUNC(COALESCE(FYHS_DATA_EFF_STRT_DT, TO_TIMESTAMP('1111-12-31', 'YYYY-MM-DD'))) <= TO_TIMESTAMP('2025-12-01', 'YYYY-MM-DD')
    ) DM
