...
(
        ...
        FROM        EDV.TR_HS,EDV.TR_H, EDV.CROP_TR_DCP_L,EDV.CROP_TR_YR_DCP_LS
        ...
        SELECT      DISTINCT CROP_TR_DCP_L.CROP_TR_DCP_L_ID INCR_DR_ID, CROP_TR_YR_DCP_ID
        FROM        EDV.LOC_AREA_MRT_SRC_RS, EDV.TR_H, EDV.CROP_TR_DCP_L, EDV.CROP_TR_YR_DCP_LS
        WHERE       (
        ...
        SELECT       DISTINCT CROP_TR_DCP_L.CROP_TR_DCP_L_ID INCR_DR_ID, CROP_TR_YR_DCP_ID
        FROM         EDV.LOC_AREA_MRT_SRC_RS, EDV.TR_HS, EDV.TR_H, EDV.CROP_TR_DCP_L, EDV.CROP_TR_YR_DCP_LS
        WHERE       (
                        CAST(LOC_AREA_MRT_SRC_RS.DATA_EFF_STRT_DT AS DATE) = TO_TIMESTAMP('{V_CDC_DT}', 'YYYY-MM-DD') 
                        OR
                        CAST(LOC_AREA_MRT_SRC_RS.DATA_EFF_END_DT AS DATE) = TO_TIMESTAMP('{V_CDC_DT}', 'YYYY-MM-DD')
        ...
        FROM        EDV.CROP_TR_YR_DCP_LS
                    ...
                    LEFT JOIN EDV.CROP_TR_CTR_LS ON CROP_TR_CTR_L.CROP_TR_CTR_L_ID = CROP_TR_CTR_LS.CROP_TR_CTR_L_ID
