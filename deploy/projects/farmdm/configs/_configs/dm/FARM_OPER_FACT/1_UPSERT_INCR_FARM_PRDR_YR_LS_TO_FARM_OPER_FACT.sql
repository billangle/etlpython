...
FROM EDV.FARM_PRDR_YR_LS FARM_PRDR_YR_LS
...
FROM EDV.LOC_AREA_MRT_SRC_RS LOC_AREA_MRT_SRC_RS, EDV.FARM_PRDR_YR_LS FARM_PRDR_YR_LS
...
UNION
SELECT DISTINCT  FARM_PRDR_YR_LS.FARM_PRDR_L_ID INCR_DR_ID, PGM_YR
FROM EDV.FARM_PRDR_CW_EXCP_RS FARM_PRDR_CW_EXCP_RS, EDV.FARM_PRDR_YR_LS FARM_PRDR_YR_LS
WHERE (CAST(FARM_PRDR_CW_EXCP_RS.DATA_EFF_STRT_DT AS DATE) =  TO_TIMESTAMP('{V_CDC_DT}','YYYY-MM-DD') 
...
UNION
SELECT DISTINCT  FARM_PRDR_YR_LS.FARM_PRDR_L_ID INCR_DR_ID, PGM_YR
FROM EDV.FARM_PRDR_PCW_EXCP_RS FARM_PRDR_PCW_EXCP_RS, EDV.FARM_PRDR_YR_LS FARM_PRDR_YR_LS
WHERE (CAST(FARM_PRDR_PCW_EXCP_RS.DATA_EFF_STRT_DT AS DATE) =  TO_TIMESTAMP('{V_CDC_DT}','YYYY-MM-DD') 
...
UNION
SELECT DISTINCT  FARM_PRDR_YR_LS.FARM_PRDR_L_ID INCR_DR_ID, PGM_YR
FROM EDV.FARM_PRDR_HEL_EXCP_RS FARM_PRDR_HEL_EXCP_RS, EDV.FARM_PRDR_YR_LS FARM_PRDR_YR_LS
WHERE (CAST(FARM_PRDR_HEL_EXCP_RS.DATA_EFF_STRT_DT AS DATE) =  TO_TIMESTAMP('{V_CDC_DT}','YYYY-MM-DD') 
...
LEFT JOIN FARM_DM_STG.RMA_FARM_PRDR_PCW_EXCP_DIM RPED ON (RPEH.DURB_ID = RPED.RMA_FARM_PRDR_PCW_EXCP_DURB_ID AND RPED.DATA_STAT_CD = 'A' ) 
 ...
 AND CAST(FS.DATA_EFF_END_DT AS DATE) = TO_TIMESTAMP('9999-12-31','YYYY-MM-DD')
 AND NOT EXISTS (SELECT '1' FROM EDV.FARM_PRDR_YR_LS FS_INN
                 ...
                 AND CAST(FS_INN.DATA_EFF_STRT_DT AS DATE) < TO_TIMESTAMP('{V_CDC_DT}','YYYY-MM-DD')
