...
(
    ...
    WHERE       CAST(FRLS.DATA_EFF_STRT_DT AS DATE) =  TO_TIMESTAMP('{ETL_DATE}','YYYY-MM-DD')
        AND     CAST(FRLS.DATA_EFF_END_DT AS DATE) > TO_TIMESTAMP('{ETL_DATE}','YYYY-MM-DD')
    ...
    WHERE       CAST(RR.DATA_EFF_STRT_DT AS DATE) =  TO_TIMESTAMP('{ETL_DATE}','YYYY-MM-DD')
        AND      CAST(RR.DATA_EFF_END_DT AS DATE) > TO_TIMESTAMP('{ETL_DATE}','YYYY-MM-DD')
),
TMP_MIDAS_FARM_RCON_LS AS
(
    SELECT      DISTINCT FARM_RCON_L_ID
    FROM        EDV.MIDAS_FARM_RCON_LS MFRLS
    WHERE       CAST(MFRLS.DATA_EFF_STRT_DT AS DATE) =  TO_TIMESTAMP('{ETL_DATE}','YYYY-MM-DD')
        AND     CAST(MFRLS.DATA_EFF_END_DT AS DATE) > TO_TIMESTAMP('{ETL_DATE}','YYYY-MM-DD')
    ...
    FROM        (
                    ...
                    WHERE       CAST(FYS.DATA_EFF_STRT_DT AS DATE) =  TO_TIMESTAMP('{ETL_DATE}','YYYY-MM-DD')
...
LEFT JOIN CMN_DIM_DM_STG.FARM_DIM FD_RSLT ON (
 ...
 WHERE 
  (
 (
 CAST(FRLS.DATA_EFF_STRT_DT AS DATE) =  TO_TIMESTAMP('{ETL_DATE}','YYYY-MM-DD')
 AND CAST(FRLS.DATA_EFF_END_DT AS DATE) > TO_TIMESTAMP('{ETL_DATE}','YYYY-MM-DD')
 )
 OR
 (
...
LEFT JOIN CMN_DIM_DM_STG.FSA_ST_CNTY_DIM FSD_ADM ON (
 ...
 WHERE 
  (
 (
 CAST(MFRLS.DATA_EFF_STRT_DT AS DATE) =  TO_TIMESTAMP('{ETL_DATE}','YYYY-MM-DD')
 AND CAST(MFRLS.DATA_EFF_END_DT AS DATE) > TO_TIMESTAMP('{ETL_DATE}','YYYY-MM-DD')
 )
 OR
 (
 CAST(FS.DATA_EFF_STRT_DT AS DATE) =  TO_TIMESTAMP('{ETL_DATE}','YYYY-MM-DD')
 )
 )
