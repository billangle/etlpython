...
LAS_PRNT.DATA_EFF_STRT_DT DESC,LAS_RSLT.DATA_EFF_STRT_DT DESC ) AS  ROW_NUM_PART
 ...
 (
 (
 CAST(MFX.DATA_EFF_END_DT AS DATE) =  TO_TIMESTAMP('{ETL_DATE}','YYYY-MM-DD')
 )
 OR
 (
 ...
 OR
 (
 CAST(LAS_PRNT.DATA_EFF_END_DT AS DATE) =  TO_TIMESTAMP('{ETL_DATE}','YYYY-MM-DD')
 )
 OR
 (
 CAST(LAS_RSLT.DATA_EFF_END_DT AS DATE) =  TO_TIMESTAMP('{ETL_DATE}','YYYY-MM-DD')
 ) 
 )
