...
AND CAST(DATA_EFF_STRT_DT AS DATE) =  TO_TIMESTAMP('{ETL_DATE}','YYYY-MM-DD')  
...
WHERE (CAST(LOC_AREA_MRT_SRC_RS.DATA_EFF_STRT_DT AS DATE) = TO_TIMESTAMP('{ETL_DATE}','YYYY-MM-DD')  
...
WHERE (CAST(FARM_YR_DCP_HS.DATA_EFF_STRT_DT AS DATE) =  TO_TIMESTAMP('{ETL_DATE}','YYYY-MM-DD')  
      OR CAST(FARM_YR_DCP_HS.DATA_EFF_END_DT AS DATE) =   TO_TIMESTAMP('{ETL_DATE}','YYYY-MM-DD'))   
...
WHERE (CAST(ARC_PLC_ELG_DTER_RS.DATA_EFF_STRT_DT AS DATE) =  TO_TIMESTAMP('{ETL_DATE}','YYYY-MM-DD')  
      OR CAST(ARC_PLC_ELG_DTER_RS.DATA_EFF_END_DT AS DATE) = TO_TIMESTAMP('{ETL_DATE}','YYYY-MM-DD'))   
