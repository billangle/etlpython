...
WHERE (CAST(LOC_AREA_MRT_SRC_RS.DATA_EFF_END_DT AS DATE) =  TO_TIMESTAMP('{V_CDC_DT}','YYYY-MM-DD')  
      ) 
...
WHERE (CAST(FARM_YR_DCP_HS.DATA_EFF_END_DT AS DATE) =  TO_TIMESTAMP('{V_CDC_DT}','YYYY-MM-DD')  
      )   
...
WHERE (CAST(ARC_PLC_ELG_DTER_RS.DATA_EFF_END_DT AS DATE) =  TO_TIMESTAMP('{V_CDC_DT}','YYYY-MM-DD')  
      )   
