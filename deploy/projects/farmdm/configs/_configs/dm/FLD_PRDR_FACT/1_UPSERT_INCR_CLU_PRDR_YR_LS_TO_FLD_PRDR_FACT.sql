...
SELECT  DISTINCT CLU_PRDR_L_ID INCR_DR_ID, CLU_PRDR_YR_ID
   ...
   SELECT  DISTINCT CLS.CLU_PRDR_L_ID INCR_DR_ID, CLS.CLU_PRDR_YR_ID
    ...
    WHERE       CAST(FLDS.DATA_EFF_STRT_DT AS DATE) = TO_TIMESTAMP('{ETL_DATE}', 'YYYY-MM-DD')
   ...
   SELECT  DISTINCT CLU_PRDR_YR_LS.CLU_PRDR_L_ID INCR_DR_ID, CLU_PRDR_YR_ID
    ...
    WHERE       (CAST(FLD_PRDR_CW_EXCP_RS.DATA_EFF_STRT_DT AS DATE) = TO_TIMESTAMP('{ETL_DATE}', 'YYYY-MM-DD')
                 OR CAST(FLD_PRDR_CW_EXCP_RS.DATA_EFF_END_DT AS DATE) = TO_TIMESTAMP('{ETL_DATE}', 'YYYY-MM-DD')
   ...
   SELECT  DISTINCT CLU_PRDR_YR_LS.CLU_PRDR_L_ID INCR_DR_ID, CLU_PRDR_YR_ID
    FROM        EDV.FLD_PRDR_PCW_EXCP_RS
                ,EDV.CLU_PRDR_YR_LS
    WHERE       (
                    CAST(FLD_PRDR_PCW_EXCP_RS.DATA_EFF_STRT_DT AS DATE) = TO_TIMESTAMP('{ETL_DATE}', 'YYYY-MM-DD')
                    OR CAST(FLD_PRDR_PCW_EXCP_RS.DATA_EFF_END_DT AS DATE) = TO_TIMESTAMP('{ETL_DATE}', 'YYYY-MM-DD')
   ...
   SELECT  DISTINCT CLU_PRDR_YR_LS.CLU_PRDR_L_ID INCR_DR_ID, CLU_PRDR_YR_ID
    ...
    WHERE       (
                    CAST(FLD_PRDR_HEL_EXCP_RS.DATA_EFF_STRT_DT AS DATE) = TO_TIMESTAMP('{ETL_DATE}', 'YYYY-MM-DD')
                    OR CAST(FLD_PRDR_HEL_EXCP_RS.DATA_EFF_END_DT AS DATE) = TO_TIMESTAMP('{ETL_DATE}', 'YYYY-MM-DD')
   ...
   SELECT  DISTINCT CLU_PRDR_YR_LS.CLU_PRDR_L_ID INCR_DR_ID, CLU_PRDR_YR_ID
    ...
    WHERE       (
                    CAST(RMA_CW_EXCP_RS.DATA_EFF_STRT_DT AS DATE) = TO_TIMESTAMP('{ETL_DATE}', 'YYYY-MM-DD')
                    OR CAST(RMA_CW_EXCP_RS.DATA_EFF_END_DT AS DATE) = TO_TIMESTAMP('{ETL_DATE}', 'YYYY-MM-DD')
    ...
    WHERE  (
            CAST(RMA_HEL_EXCP_RS.DATA_EFF_STRT_DT AS DATE) = TO_TIMESTAMP('{ETL_DATE}', 'YYYY-MM-DD')
            OR CAST(RMA_HEL_EXCP_RS.DATA_EFF_END_DT AS DATE) = TO_TIMESTAMP('{ETL_DATE}', 'YYYY-MM-DD')
    ...
    WHERE  (
            CAST(RMA_PCW_EXCP_RS.DATA_EFF_STRT_DT AS DATE) = TO_TIMESTAMP('{ETL_DATE}', 'YYYY-MM-DD')
             OR CAST(RMA_PCW_EXCP_RS.DATA_EFF_END_DT AS DATE) = TO_TIMESTAMP('{ETL_DATE}', 'YYYY-MM-DD')
...
FROM    
  ...
  And TO_TIMESTAMP('{ETL_DATE}','YYYY-MM-DD') >= CAST(data_eff_strt_dt AS DATE)
...
LEFT JOIN EDV.FLD_CLU_YR_HS FLDS
 ON (  COALESCE(CLS.CLU_YR_ID ,-1)= COALESCE(FLDS.CLU_YR_ID,'-1')
  And TO_TIMESTAMP('{ETL_DATE}','YYYY-MM-DD') >= CAST(FLDS.data_eff_strt_dt AS DATE)
  And TO_TIMESTAMP('{ETL_DATE}','YYYY-MM-DD') < CAST(FLDS.data_eff_end_dt AS DATE)
 )
...
LEFT JOIN EDV.FLD_PRDR_INVL_RS PRS ON (CLS.SRC_PRDR_INVL_CD = PRS.DMN_VAL_ID 
 And TO_TIMESTAMP('{ETL_DATE}','YYYY-MM-DD') >= CAST(PRS.data_eff_strt_dt AS DATE)
  And TO_TIMESTAMP('{ETL_DATE}','YYYY-MM-DD') < CAST(PRS.data_eff_end_dt AS DATE)) 
...
LEFT JOIN CMN_DIM_DM_STG.TR_DIM TD
 ...
 And TO_TIMESTAMP('{ETL_DATE}','YYYY-MM-DD') >= CAST(CWE.data_eff_strt_dt AS DATE)
  And TO_TIMESTAMP('{ETL_DATE}','YYYY-MM-DD') < CAST(CWE.data_eff_end_dt AS DATE)) 
 ...
 And TO_TIMESTAMP('{ETL_DATE}','YYYY-MM-DD') >= CAST(HES.data_eff_strt_dt AS DATE)
  And TO_TIMESTAMP('{ETL_DATE}','YYYY-MM-DD') < CAST(HES.data_eff_end_dt AS DATE))               
 ...
 And TO_TIMESTAMP('{ETL_DATE}','YYYY-MM-DD') >= CAST(PES.data_eff_strt_dt AS DATE)
  And TO_TIMESTAMP('{ETL_DATE}','YYYY-MM-DD') < CAST(PES.data_eff_end_dt AS DATE))               
...
LEFT JOIN EDV.RMA_CW_EXCP_RS RCWE ON (CLS.CLU_PRDR_RMA_CW_EXCP_CD = RCWE.DMN_VAL_ID 
 And TO_TIMESTAMP('{ETL_DATE}','YYYY-MM-DD') >= CAST(RCWE.data_eff_strt_dt AS DATE)
  And TO_TIMESTAMP('{ETL_DATE}','YYYY-MM-DD') < CAST(RCWE.data_eff_end_dt AS DATE))
 ...
 And TO_TIMESTAMP('{ETL_DATE}','YYYY-MM-DD') >= CAST(RHES.data_eff_strt_dt AS DATE)
  And TO_TIMESTAMP('{ETL_DATE}','YYYY-MM-DD') < CAST(RHES.data_eff_end_dt AS DATE))     
 ...
 LEFT JOIN EDV.RMA_PCW_EXCP_RS RPES ON (CLS.CLU_PRDR_RMA_PCW_EXCP_CD = RPES.DMN_VAL_ID
  And TO_TIMESTAMP('{ETL_DATE}','YYYY-MM-DD') >= CAST(RPES.data_eff_strt_dt AS DATE)
  And TO_TIMESTAMP('{ETL_DATE}','YYYY-MM-DD') < CAST(RPES.data_eff_end_dt AS DATE))                   
