...
SELECT  DISTINCT CLU_PRDR_L_ID INCR_DR_ID, CLU_PRDR_YR_ID
   ...
   SELECT  DISTINCT CLS.CLU_PRDR_L_ID INCR_DR_ID, CLS.CLU_PRDR_YR_ID
    ...
    WHERE       CAST(FLDS.DATA_EFF_STRT_DT AS DATE) = TO_TIMESTAMP('{V_CDC_DT}', 'YYYY-MM-DD')
   ...
   SELECT  DISTINCT CLU_PRDR_YR_LS.CLU_PRDR_L_ID INCR_DR_ID, CLU_PRDR_YR_ID
    ...
    WHERE       (CAST(FLD_PRDR_CW_EXCP_RS.DATA_EFF_STRT_DT AS DATE) = TO_TIMESTAMP('{V_CDC_DT}', 'YYYY-MM-DD')
                 OR CAST(FLD_PRDR_CW_EXCP_RS.DATA_EFF_END_DT AS DATE) = TO_TIMESTAMP('{V_CDC_DT}', 'YYYY-MM-DD')
   ...
   SELECT  DISTINCT CLU_PRDR_YR_LS.CLU_PRDR_L_ID INCR_DR_ID, CLU_PRDR_YR_ID
    FROM        EDV.FLD_PRDR_PCW_EXCP_RS
                ,EDV.CLU_PRDR_YR_LS
    WHERE       (
                    CAST(FLD_PRDR_PCW_EXCP_RS.DATA_EFF_STRT_DT AS DATE) = TO_TIMESTAMP('{V_CDC_DT}', 'YYYY-MM-DD')
                    OR CAST(FLD_PRDR_PCW_EXCP_RS.DATA_EFF_END_DT AS DATE) = TO_TIMESTAMP('{V_CDC_DT}', 'YYYY-MM-DD')
   ...
   SELECT  DISTINCT CLU_PRDR_YR_LS.CLU_PRDR_L_ID INCR_DR_ID, CLU_PRDR_YR_ID
    ...
    WHERE       (
                    CAST(FLD_PRDR_HEL_EXCP_RS.DATA_EFF_STRT_DT AS DATE) = TO_TIMESTAMP('{V_CDC_DT}', 'YYYY-MM-DD')
                    OR CAST(FLD_PRDR_HEL_EXCP_RS.DATA_EFF_END_DT AS DATE) = TO_TIMESTAMP('{V_CDC_DT}', 'YYYY-MM-DD')
   ...
   SELECT  DISTINCT CLU_PRDR_YR_LS.CLU_PRDR_L_ID INCR_DR_ID, CLU_PRDR_YR_ID
    ...
    WHERE       (
                    CAST(RMA_CW_EXCP_RS.DATA_EFF_STRT_DT AS DATE) = TO_TIMESTAMP('{V_CDC_DT}', 'YYYY-MM-DD')
                    OR CAST(RMA_CW_EXCP_RS.DATA_EFF_END_DT AS DATE) = TO_TIMESTAMP('{V_CDC_DT}', 'YYYY-MM-DD')
    ...
    WHERE  (
            CAST(RMA_HEL_EXCP_RS.DATA_EFF_STRT_DT AS DATE) = TO_TIMESTAMP('{V_CDC_DT}', 'YYYY-MM-DD')
            OR CAST(RMA_HEL_EXCP_RS.DATA_EFF_END_DT AS DATE) = TO_TIMESTAMP('{V_CDC_DT}', 'YYYY-MM-DD')
    ...
    WHERE  (
            CAST(RMA_PCW_EXCP_RS.DATA_EFF_STRT_DT AS DATE) = TO_TIMESTAMP('{V_CDC_DT}', 'YYYY-MM-DD')
             OR CAST(RMA_PCW_EXCP_RS.DATA_EFF_END_DT AS DATE) = TO_TIMESTAMP('{V_CDC_DT}', 'YYYY-MM-DD')
