with incr_RMA_FARM_PRDR_CW_EXCP_DIM  as
...
where data_src_nm <> 'SYSGEN' AND  RMA_CW_EXCP_CD  in (select dr_id from incr_RMA_FARM_PRDR_CW_EXCP_DIM )) dv_dr
LEFT JOIN 
(
select 
RMA_CW_EXCP_CD,
