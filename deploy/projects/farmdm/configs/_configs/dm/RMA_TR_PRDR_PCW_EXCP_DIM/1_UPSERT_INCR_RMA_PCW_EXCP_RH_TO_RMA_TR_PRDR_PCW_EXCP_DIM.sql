...
dv_dr.durb_id AS RMA_TR_PRDR_PCW_EXCP_DURB_ID
...
select 	rma_tr_prdr_pcw_excp_durb_id,
...
where rma_tr_prdr_pcw_excp_durb_id > 0
order by rma_tr_prdr_pcw_excp_durb_id asc