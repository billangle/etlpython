...
From        (
                select      /*+ PARALLEL(8) */ 
                            ...
                            greatest
                            (
                                nvl(THS.DATA_EFF_STRT_DT, TO_TIMESTAMP('1111-12-31','YYYY-MM-DD')),
                                nvl(ADM.DATA_EFF_STRT_DT,TO_TIMESTAMP('1111-12-31','YYYY-MM-DD')),
                                nvl(LOC.DATA_EFF_STRT_DT,TO_TIMESTAMP('1111-12-31','YYYY-MM-DD')),
                                nvl(CDS.DATA_EFF_STRT_DT,TO_TIMESTAMP('1111-12-31','YYYY-MM-DD')),
                                nvl(WLS.DATA_EFF_STRT_DT,TO_TIMESTAMP('1111-12-31','YYYY-MM-DD'))
                            ) DATA_EFF_STRT_DT,
                            TH.ST_FSA_CD        ST_FSA_CD,
                            TH.CNTY_FSA_CD      CNTY_FSA_CD,
                            ADM.CTRY_DIV_NM     ST_FSA_NM,
                            ADM.LOC_AREA_NM     CNTY_FSA_NM,
                            TH.TR_NBR           TR_NBR,
                            THS.SRC_CRE_DT      TR_CRE_DT,
                            THS.SRC_LAST_CHG_DT         TR_LAST_CHG_DT,
                            THS.SRC_LAST_CHG_USER_NM    TR_LAST_CHG_USER_NM,
                            THS.DATA_STAT_CD            SRC_DATA_STAT_CD,
                            THS.TR_DESC                 TR_DESC,
                            THS.BIA_RNG_UNIT_NBR        BIA_RNG_UNIT_NBR,
                            THS.LOC_ST_FSA_CD           LOC_ST_FSA_CD,
                            THS.LOC_CNTY_FSA_CD         LOC_CNTY_FSA_CD,
                            LOC.CTRY_DIV_NM             LOC_ST_FSA_NM,
                            LOC.LOC_AREA_NM             LOC_CNTY_FSA_NM,
                            THS.CONG_DIST_CD            CONG_DIST_CD,
                            CDS.CONG_DIST_NM            CONG_DIST_NM,
                            WLS.WL_CERT_CPLT_CD         WL_CERT_CPLT_CD,
                            THS.WL_CERT_CPLT_NM         WL_CERT_CPLT_DESC,
                            THS.WL_CERT_CPLT_YR         WL_CERT_CPLT_YR,
                            ROW_NUMBER() OVER 
                            (
