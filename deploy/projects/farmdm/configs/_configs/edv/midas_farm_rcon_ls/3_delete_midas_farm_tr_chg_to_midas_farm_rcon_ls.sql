...
where MIDAS_FARM_TR_CHG.FARM_CHG_TYPE_ID = 1142 and MIDAS_FARM_TR_CHG.CDC_OPER_CD='D'
...
FARM_RCON_L_ID,MIDAS_FARM_TR_CHG_ID,LOAD_DT,
DATA_EFF_STRT_DT,
DATA_SRC_NM,
DATA_STAT_CD,
SRC_CRE_DT,
...
HASH_DIF)
VALUES (
stg.FARM_RCON_L_ID,stg.MIDAS_FARM_TR_CHG_ID,stg.LOAD_DT,stg.DATA_EFF_STRT_DT,
stg.DATA_SRC_NM,stg.DATA_STAT_CD,stg.SRC_CRE_DT,stg.SRC_CRE_USER_NM,stg.SRC_LAST_CHG_DT,
stg.SRC_LAST_CHG_USER_NM,stg.SRC_FARM_CHG_TYPE_ID,stg.FARM_CHG_TYPE_NM,stg.PRNT_ST_FSA_CD,
stg.PRNT_CNTY_FSA_CD,stg.PRNT_FARM_NBR,stg.RSLT_ST_FSA_CD,stg.RSLT_CNTY_FSA_CD,stg.RSLT_FARM_NBR,
