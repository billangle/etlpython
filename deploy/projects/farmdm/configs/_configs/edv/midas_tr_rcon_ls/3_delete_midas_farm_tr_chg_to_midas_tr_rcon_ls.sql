Merge into
EDV.MIDAS_TR_RCON_LS dv
using(select DISTINCT 
MD5(MD5(upper(coalesce(MIDAS_FARM_TR_CHG.PRNT_ST_FSA_CD ,'--')||'~~'||coalesce(MIDAS_FARM_TR_CHG.PRNT_CNTY_FSA_CD,'--')
||'~~'||coalesce((MIDAS_FARM_TR_CHG.PRNT_TR_NBR)::numeric ,-1)))||'~~'||MD5(upper(coalesce(MIDAS_FARM_TR_CHG.RSLT_ST_FSA_CD ,'--')
||'~~'||coalesce(MIDAS_FARM_TR_CHG.RSLT_CNTY_FSA_CD,'--')||'~~'||coalesce((MIDAS_FARM_TR_CHG.RSLT_TR_NBR)::numeric , -1)))) as TR_RCON_L_ID,
...
MD5(upper(coalesce((MIDAS_FARM_TR_CHG.PRNT_TR_NBR)::numeric , -1)||'~~'||coalesce(MIDAS_FARM_TR_CHG.PRNT_ST_FSA_CD,'--')||'~~'||coalesce(MIDAS_FARM_TR_CHG.PRNT_CNTY_FSA_CD,'--'))||'~~'||upper(coalesce((MIDAS_FARM_TR_CHG.RSLT_TR_NBR)::numeric ,-1)||'~~'||coalesce(MIDAS_FARM_TR_CHG.RSLT_ST_FSA_CD,'--')||'~~'||coalesce(MIDAS_FARM_TR_CHG.RSLT_CNTY_FSA_CD,'--'))||'~~'||MIDAS_FARM_TR_CHG.MIDAS_FARM_TR_CHG_ID||'~~'||trim(both MIDAS_FARM_TR_CHG.DATA_STAT_CD)||'~~'||to_char(MIDAS_FARM_TR_CHG.CRE_DT,'YYYY-MM-DD HH24:MI:SS.US')||'~~'||trim(both MIDAS_FARM_TR_CHG.CRE_USER_NM)||'~~'||to_char(MIDAS_FARM_TR_CHG.LAST_CHG_DT,'YYYY-MM-DD HH24:MI:SS.US')||'~~'||trim(both MIDAS_FARM_TR_CHG.LAST_CHG_USER_NM)||'~~'||MIDAS_FARM_TR_CHG.FARM_CHG_TYPE_ID||'~~'||FARM_CHG_TYPE_RS.DMN_VAL_NM||'~~'||trim(both MIDAS_FARM_TR_CHG.PRNT_ST_FSA_CD)||'~~'||trim(both MIDAS_FARM_TR_CHG.PRNT_CNTY_FSA_CD)||'~~'||(MIDAS_FARM_TR_CHG.PRNT_TR_NBR)::numeric ||'~~'||trim(both MIDAS_FARM_TR_CHG.RSLT_ST_FSA_CD)||'~~'||trim(both MIDAS_FARM_TR_CHG.RSLT_CNTY_FSA_CD)||'~~'||(MIDAS_FARM_TR_CHG.RSLT_TR_NBR)::numeric ||MIDAS_FARM_TR_CHG.TM_PRD_ID||trim(both MIDAS_FARM_TR_CHG.RCON_SEQ_NBR)||to_char(MIDAS_FARM_TR_CHG.RCON_INIT_DT,'YYYY-MM-DD HH24:MI:SS.US')||to_char(MIDAS_FARM_TR_CHG.RCON_APVL_DT,'YYYY-MM-DD HH24:MI:SS.US')||trim(both MIDAS_FARM_TR_CHG.TM_PRD_NM)) HASH_DIF
...
where MIDAS_FARM_TR_CHG.FARM_CHG_TYPE_ID = 1143 and MIDAS_FARM_TR_CHG.CDC_OPER_CD='D'
...
TR_RCON_L_ID,MIDAS_FARM_TR_CHG_ID,LOAD_DT,
DATA_EFF_STRT_DT,
DATA_SRC_NM,
DATA_STAT_CD,
SRC_CRE_DT,
...
HASH_DIF)
VALUES (
stg.TR_RCON_L_ID,stg.MIDAS_FARM_TR_CHG_ID,
stg.LOAD_DT,stg.DATA_EFF_STRT_DT,stg.DATA_SRC_NM,stg.DATA_STAT_CD,
stg.SRC_CRE_DT,stg.SRC_CRE_USER_NM,stg.SRC_LAST_CHG_DT,
stg.SRC_LAST_CHG_USER_NM,stg.SRC_FARM_CHG_TYPE_ID,stg.FARM_CHG_TYPE_NM,
stg.PRNT_ST_FSA_CD,stg.PRNT_CNTY_FSA_CD,stg.PRNT_TR_NBR,
stg.RSLT_ST_FSA_CD,stg.RSLT_CNTY_FSA_CD,stg.RSLT_TR_NBR,
