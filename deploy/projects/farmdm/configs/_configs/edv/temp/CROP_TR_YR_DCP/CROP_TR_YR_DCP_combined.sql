...
'SQL_FARM_RCD',
CURRENT_DATE - 1
-- Extra columns not in INSERT
-- crop_tract_year_dcp.fav_ccp_payment_yield,
-- crop_tract_year_dcp.fav_direct_payment_yield,
-- crop_tract_year_dcp.fav_reduction_acreage,
-- tract_year_dcp.tract_year_identifier,
-- crop.fsa_crop_abbreviation,
-- crop.fsa_crop_name,
-- crop.fsa_crop_type_name,
-- county_office_control.county_fsa_code,
-- county_office_control.state_fsa_code
...
where ctyd.cdc_dt >= DATE '2025-11-17'