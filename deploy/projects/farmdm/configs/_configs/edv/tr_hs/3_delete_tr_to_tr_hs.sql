...
--and date_trunc('day', TR.CDC_DT) = date_trunc('day', TO_TIMESTAMP('<DATA_EFF_STRT_DT>', 'YYYY-MM-DD HH24:MI:SS.FF'))
--and TR.LOAD_DT = TO_TIMESTAMP('<LOAD_DT>', 'YYYY-MM-DD HH24:MI:SS.FF')
order by TR.CDC_DT)
stg
 on ( 
...
VALUES (
stg.TR_H_ID,stg.TR_ID,stg.LOAD_DT,stg.DATA_EFF_STRT_DT,stg.DATA_SRC_NM,stg.DATA_STAT_CD,stg.SRC_CRE_DT,stg.SRC_LAST_CHG_DT,stg.SRC_LAST_CHG_USER_NM,stg.CNTY_OFC_CTL_ID,stg.TR_DESC,stg.BIA_RNG_UNIT_NBR,stg.LOC_ST_FSA_CD,stg.LOC_CNTY_FSA_CD,stg.CONG_DIST_CD,stg.SRC_WL_CERT_CPLT_CD,stg.WL_CERT_CPLT_NM,stg.WL_CERT_CPLT_YR,stg.SRC_TR_NBR,stg.DATA_EFF_STRT_DT,stg.LOAD_DT,
stg.HASH_DIF
);