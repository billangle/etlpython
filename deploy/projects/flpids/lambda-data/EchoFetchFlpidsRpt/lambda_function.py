...
def lambda_handler(event, context):
    ...
    {
        "file_pattern": "(MFO900\\.MOYRPT.\\w{1,128})\\.DATA\\.(\\d{14})$",      # required
        "echo_folder": "plas",                                                   # required
        "pipeline": "FLPIDS_RPT",                                                # required
        "step": "flpids_rpt Landing Zone (Weekly)",                              # required
            ...
            with DARTSession(
                ...
                if ftps.size(file["name"]) > 500000000:
                    ...
                    arguments = {
                        ...
                        "--job_id": context.log_stream_name,
                        "--EchoFolder": event.get("echo_folder")
                    }
