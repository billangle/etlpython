...
#
# Jenkins Job: FSA-PROD-DART-ECHO-FETCH-FLPIDS-CAORPT
#
...
JENKINS_JOB_NAME="FSA-PROD-DART-ECHO-FETCH-FLPIDS-CAORPT"
PROJECT_NAME="${JENKINS_JOB_NAME#*ECHO-FETCH-}"
: "${STEP:=CAO_RPT Landing Zone (Daily)}"
: "${ENV:=CERT}"
export PROJECT_NAME
...
if [ -z "${ECHO_SUBFOLDER:-}" ]; then ECHO_SUBFOLDER='daily'; fi
