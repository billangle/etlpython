...
#
# Jenkins Job: FSA-PROD-DART-ECHO-FETCH-FLPIDS-CAORPT-ORGANIZATION
#
...
JENKINS_JOB_NAME="FSA-PROD-DART-ECHO-FETCH-FLPIDS-CAORPT-ORGANIZATION"
...
if [ -z "${FILE_PATTERN:-}" ]; then FILE_PATTERN='(ORGN|DVSN)\.TXT'; fi
