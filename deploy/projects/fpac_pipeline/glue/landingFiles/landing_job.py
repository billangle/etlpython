...
args = getResolvedOptions(sys.argv, ["JOB_NAME", "landing_bucket" , "project", "bucket_region"])
...
input_path = f"s3a://{landing_bucket}/{project}/dbo/"
output_path = f"s3a://{landing_bucket}/{project}/etl-jobs/"
