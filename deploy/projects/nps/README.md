...
- Branch naming: `<PROJECT>-<JIRA-TICKET>` (example: `NPS-POPSUP-7557`)
- `NPS` is the project code used in the command examples below.
...
git checkout -b NPS-POPSUP-7557

# Commit and push (triggers DEV automation)
git add .
git commit -m "NPS-POPSUP-7557: describe change"
git push -u origin NPS-POPSUP-7557

# Daily sync main into feature branch to reduce merge conflicts
git fetch origin
git checkout main
git pull origin main
git checkout NPS-POPSUP-7557
git merge main
git push
```
