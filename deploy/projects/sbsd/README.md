...
- Branch naming: `<PROJECT>-<JIRA-TICKET>` (example: `SBSD-POPSUP-7557`)
- `SBSD` is the project code used in the command examples below.
...
git checkout -b SBSD-POPSUP-7557

# Commit and push (triggers DEV automation)
git add .
git commit -m "SBSD-POPSUP-7557: describe change"
git push -u origin SBSD-POPSUP-7557

# Daily sync main into feature branch to reduce merge conflicts
git fetch origin
git checkout main
git pull origin main
git checkout SBSD-POPSUP-7557
git merge main
git push
```
