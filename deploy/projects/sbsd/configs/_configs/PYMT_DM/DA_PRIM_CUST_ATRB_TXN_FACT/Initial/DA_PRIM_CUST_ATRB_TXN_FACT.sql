INSERT INTO pymt_dm_stg.DA_PRIM_CUST_ATRB_TXN_FACT(
PYMT_ATRB_ID,
PRPS_PYMT_ID,
PRV_PRPS_PYMT_ID,
PRNT_PYMT_ATRB_ID,
...
Select 
 ...
 DV_DR.DATA_ACTN_DT,
 case 
	 when DV_DR.DATA_ACTN_DT is null Then 1 
	 else  0 
	 End As LATEST_PYMT_ATRB_TXN_IND,
...
Left Join pymt_dm_stg.ACCT_REF_TYPE_DIM  ACCT_REF_TYPE_PRIM_DIM
 ...
 /*
 LEFT JOIN  pymt_dm_stg.DA_PRIM_CUST_ATRB_TXN_FACT dm
  on (
