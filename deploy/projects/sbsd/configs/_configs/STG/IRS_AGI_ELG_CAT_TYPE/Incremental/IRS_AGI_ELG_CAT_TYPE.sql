...
,irs_agi_eligibility_error_category_description AS IRS_AGI_ELG_ERR_CAT_DESC
,irs_agi_eligibility_error_category_name AS IRS_AGI_ELG_ERR_CAT_NM
,last_change_date AS LAST_CHG_DT
,last_change_user_name AS LAST_CHG_USER_NM
, op AS CDC_OPER_CD FROM `fsa-{env}-sbsd-cdc`.`irs_agi_eligibility_error_category`
