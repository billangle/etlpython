...
SELECT * FROM
(
SELECT DISTINCT PYMT_ATRB_RDN_ID,
PYMT_ATRB_ID,
PRPS_PYMT_ID,
ST_FSA_CD,
CNTY_FSA_CD,
...
payment_attribution_reduction.payment_attribution_identifier PYMT_ATRB_ID,
...
payment_attribution_reduction.total_payment_attribution_reduction_amount TOT_PYMT_ATRB_RDN_AMT,
payment_attribution_reduction.data_status_code DATA_STAT_CD,
payment_attribution_reduction.creation_date CRE_DT,
payment_attribution_reduction.creation_user_name CRE_USER_NM,
...
1 AS TBL_PRIORITY
FROM `fsa-{env}-sbsd-cdc`.`payment_attribution_reduction`
...
LEFT JOIN `fsa-{env}-sbsd-cdc`.`payment_attribution`
ON (payment_attribution_reduction.payment_attribution_identifier = payment_attribution.payment_attribution_identifier)
...
JOIN `fsa-{env}-sbsd-cdc`.`payment_attribution_reduction`
ON (proposed_payment.proposed_payment_identifier = payment_attribution_reduction.proposed_payment_identifier)
LEFT JOIN `fsa-{env}-sbsd-cdc`.`payment_attribution`
ON (payment_attribution_reduction.payment_attribution_identifier = payment_attribution.payment_attribution_identifier)
LEFT JOIN `fsa-{env}-sbsd-cdc`.`subsidiary_customer`
ON (payment_attribution.subsidiary_customer_identifier = subsidiary_customer.subsidiary_customer_identifier)
...
JOIN `fsa-{env}-sbsd-cdc`.`payment_attribution`
ON (subsidiary_customer.subsidiary_customer_identifier = payment_attribution.subsidiary_customer_identifier)
JOIN `fsa-{env}-sbsd-cdc`.`payment_attribution_reduction`
ON (payment_attribution.payment_attribution_identifier = payment_attribution_reduction.payment_attribution_identifier)
LEFT JOIN `fsa-{env}-sbsd-cdc`.`proposed_payment`
ON (payment_attribution_reduction.proposed_payment_identifier = proposed_payment.proposed_payment_identifier)
/*get paid customer information*/
LEFT JOIN `fsa-{env}-sbsd-cdc`.`subsidiary_customer` paid_subsidiary_customer
