INSERT INTO EDV.CMB_PRDR_ACCT_PRD_LS (CMB_PRDR_ACCT_PRD_L_ID, LOAD_DT, DATA_EFF_STRT_DT, DATA_SRC_NM, SBSD_PRD_ID, CMB_PRDR_ACCT_ID, DATA_EFF_END_DT, LOAD_END_DT)
  (SELECT stg.*
   FROM
   ...
   LEFT JOIN EDV.CMB_PRDR_ACCT_PRD_LS dv ON (dv.CMB_PRDR_ACCT_PRD_L_ID= stg.CMB_PRDR_ACCT_PRD_L_ID
   ...
   WHERE dv.CMB_PRDR_ACCT_PRD_L_ID IS NULL )