INSERT INTO EDV.DIST_PYMT_LMT_RS (DIST_NM, SBSD_PRD_NM, LOAD_DT, DATA_EFF_STRT_DT, DATA_SRC_NM, DATA_STAT_CD, SBSD_PRD_ID, SBSD_PRD_ST_ID, SCHL_PYMT_LMT_IND, SRC_CRE_DT, SRC_CRE_USER_NM, SRC_LAST_CHG_DT, SRC_LAST_CHG_USER_NM, ST_FSA_CD, CTRY_DIV_ID, CTRY_DIV_CAT_ID, CTRY_DIV_REF_ID, DATA_EFF_END_DT, LOAD_END_DT)
  (SELECT stg.*
   FROM
   ...
   LEFT JOIN EDV.DIST_PYMT_LMT_RS dv ON (coalesce(stg.DIST_NM, 'X') = coalesce(dv.DIST_NM, 'X')
