INSERT INTO EDV.PR_PYMT_ATRB_MBR_HLS (PYMT_ATRB_MBR_HL_ID, PYMT_ATRB_ID, DATA_ACTN_DT, PRPS_PYMT_ID, ACCT_PGM_CD, AGI_ELG_IND, AGI_ERR_REF_CD, BUS_TYPE_CD, CASH_RENT_CPLD_FCTR, CMB_PTY_PYMT_SHR_PCT, CNTY_FSA_CD, DATA_ACTN_CD, DATA_STAT_CD, FGN_PRSN_ELG_IND, MBR_CORE_CUST_ID, MBR_CTRB_ELG_IND, MBR_CTRB_SHR_PCT, MBR_SHR_PCT, NET_PYMT_AMT, OWNSHP_HRCH_LVL_SHR_PCT, PAID_CORE_CUST_ID, PAID_PTY_SHR_PCT, PAID_SBSD_CUST_ID, PGM_INELG_RSN_TYPE_CD, PMIT_ENTY_ELG_IND, PRNT_PYMT_ATRB_ACCT_PGM_CD, PRNT_PYMT_ATRB_CNTY_FSA_CD, PRNT_PYMT_ATRB_CORE_CUST_ID, PRNT_PYMT_ATRB_ID, PRNT_PYMT_ATRB_SBSD_PRD_YR, PRNT_PYMT_ATRB_ST_FSA_CD, PRPS_PYMT_ACCT_PGM_CD, PRPS_PYMT_SBSD_PRD_STRT_YR, PYMT_ATRB_AMT, PYMT_ATRB_BUS_CAT_CD, PYMT_ATRB_SHR_PCT, PYMT_LMT_YR, PYMT_PGM_ID, PYMT_PTY_RLT_CD, RCD_REF_PRIM_ID, RCD_REF_PRIM_ID_TYPE_CD, RCD_REF_SCND_ID, RCD_REF_SCND_ID_TYPE_CD, SBSD_CUST_ID, SBSD_PRD_STRT_YR, SBST_CHG_ELG_IND, SRC_CRE_DT, SRC_CRE_USER_NM, SRC_LAST_CHG_DT, SRC_LAST_CHG_USER_NM, ST_FSA_CD, TAX_ID_TYPE_CD, TOT_NET_PYMT_AMT, TOT_PYMT_ATRB_AMT, LOAD_DT, DATA_EFF_STRT_DT, DATA_SRC_NM, DATA_EFF_END_DT, LOAD_END_DT, HASH_DIF)
  (SELECT stg.*
   ...
   LEFT JOIN EDV.PR_PYMT_ATRB_MBR_HLS dv ON (stg.HASH_DIF = dv.HASH_DIF
